...
#define STRING_CONFIG_H_AUTHOR "0xB0D 21/03/24" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "0xB0D's 3D super p00per"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -10, 110, 0 }
